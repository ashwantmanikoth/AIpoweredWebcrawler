...
with gr.Blocks() as ui:
    gr.Markdown("""#    <p style="text-align:center;">IntelliSearch Engine!</p>
                 <p style="text-align:center;">An AI-powered search assistant using Retrieval Augmented Generation (RAG).</p>
    """) 
    with gr.Row():
        with gr.Column(scale=1):
            gr.Markdown("<br>")  # Moves sidebar down
            ...
            rag_type_dropdown = gr.Dropdown(choices=modes, label="Select type of retrieval")
